...
void *event_loop_thread_run(void *arg) {
    ...
    //TODO: yolanda_msgx("event loop thread init and signal, %s", eventLoopThread->thread_name);
...
struct event_loop *event_loop_thread_start(struct event_loop_thread *eventLoopThread) {
    ...
    //TODO: yolanda_msgx("event loop thread started, %s", eventLoopThread->thread_name);
